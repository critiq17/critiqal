...
export class UseProfilePage {
	...
	// Cached counts (kept in sync with lists when loaded; otherwise derived from
	// optimistic toggleFollow). Backend doesn't expose counts directly, so until
	// it does we display "—" until lists are first loaded.
